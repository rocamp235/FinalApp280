...
//  FinalApp280
//
//  Created by Roberto Ocampo on 12/11/19.
...
class ContactTableViewController: UITableViewController,UISearchResultsUpdating, UISearchBarDelegate, UISearchControllerDelegate {
    ...
    func updateSearchResults(for searchController: UISearchController)
    {
        ...
        let searchPredicate = NSPredicate(format: "notetext CONTAINS[c] %@", searchController.searchBar.text!)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (self.resultSearchController.isActive) {
            ...
            cell?.textLabel?.text = person.value(forKey: "notetext") as! String?
